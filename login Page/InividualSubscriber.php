...
function validateForm(form)
{
    ...
    /*re = /^[A-Za-z]+$/;
     if(!re.test(form.txtShow1.value)) {
     ...
     re = /^[0-9]+$/;
     if(!re.test(form.txtShow7.value)) {
...
<?php
    ...
    $phone =  mysqli_real_escape_string($conn,$_POST['phnum']);
    ...
    $expirymonth =  mysqli_real_escape_string($conn,$_POST['txtShow5']);
    $expiryyear =  mysqli_real_escape_string($conn,$_POST['txtShow9']);
    ...
    if(!empty($fname)){
    $query = "insert into individualApplicant ( fName,lName,emailId,phoneNum,addLine1,addLine2,city,state,zip,numOfCopiesPerMonth,paymentMethod,nameOnCard,creditCardNumber,expirationMonth,expirationYear,cvv,nameOnCheck,routingNumber,accountNumber,typeOfAccount,subDuration) values ('$fname','$lname','$email','$phone','$addline1','$addline2','$city','$state','$zip','$numcopies','$paymethod','$nameoncard','$cardno','$expirymonth','$expiryyear','$cvv','$nameoncheck','$routingnumber','$accountnumber','$typeofaccount','$subduration')";
        ...
        <img src="img/logo.png"><img class="title" src="img/Sportzmagazine.png">
            <nav id="navmenu"><ul>
                ...
                <li><a href="#" style="background:#FFCC33;">Subscribe&nbsp;&nbsp;&#9660;</a></style>
                    <ul class="sub1">
                        <li class="active"><a href="../login Page/InividualSubscriber.php">Individual</a></li>
                        <li class="abc"><a href="../login Page/CorporateSubscriber.php">Corporate</a></li>
                    </ul>
                </li>
        ...
        <div class="content">
            <div id="form_wrapper" class="form_wrapper">
                <div class="register_width">
                    <form class="register active" onsubmit="return validateForm(this);" method="POST" action="InividualSubscriber.php">
                        ...
                        <fieldset>
                            ...
                            <div class="column">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="phnum" style="width:60%;" placeholder="( -  -  - )    -  -  -    -  -  -  -" required/>
                                    <span class="error">This is an error</span>
                                </div>
                            </div>
                            <div class="column1">
                        ...
                        <fieldset>
                            ...
                            <div class="column">
                                ...
                                <div>
                                    <label>City:</label>
                                    <input type="text" name="city" style="width:50%;" required/>
                                    <span class="error">This is an error</span>
                                </div>
                                <div>
                                    <label>Zip Code:</label>
                                    <input type="text" name="zip" style="width:40%;" required/>
                                    <span class="error">This is an error</span>
                                </div>
                            </div>
                            <div class="column1">
                                ...
                                <div>
                                    <label>State:</label>
                                    <select style="float:left;margin: 5px 25px 10px 29px;width:60%;line-height:3px;height:35px;border: solid 1px #E5E5E5;background:
                                        -webkit-gradient(
                                        linear,
                                        left top,
                                        left 25,
                                        ...
                                        color-stop(4%, #EEEEEE),
                                        to(#FFFFFF)
                                        );font-size:16px;" name="state" required>
                        ...
                        <fieldset>
                            ...
                            <div class="column">
                                <div>
                                    ...
                                    <input type="text" name="numcopies" style="width:30%;" required/>
                                    <span class="error">This is an error</span>
                                </div>
                                </div>
                                <div class="column1">
                                <div>
                                    <label style="margin: 15px 35px 20px 35px;">Subscription Duration:
                                        <select style="float:left;width:70%;line-height:3px;height:35px;border: solid 1px #E5E5E5;background:
                                            -webkit-gradient(
                                            linear,
                                            left top,
                                            left 25,
                                            ...
                                            color-stop(4%, #EEEEEE),
                                            to(#FFFFFF)
                                            );font-size:16px;" name="subduration" required>
                        ...
                        <fieldset>
                            ...
                            <select id="txtShow9" name="txtShow9" style="display:none;margin:7px 10px 10px 1px;float:left;width:10%;line-height:3px;height:35px;border: solid 1px #E5E5E5;background:
                                -webkit-gradient(
                                linear,
                                left top,
                                left 25,
                            ...
                            <label float:"left" id="txtShow17" name="txtShow17" style="display:none;margin: 7px 1px 1px 1px;"><br><br>CVV:</label>
                            ...
                            name="txtShow2" style="display:none; width:40%; float:left" />
